    ...
    return (
      <>
        ...
        <style>{`
          ...
          .btn-glass-lens-${filterId} {
            background-color: ${glassColor || "rgba(254, 253, 251, 0.06)"};
            backdrop-filter: blur(8px) url(#liquid-glass-${filterId}) saturate(150%);
            -webkit-backdrop-filter: blur(8px) saturate(150%);
            box-shadow:
              inset 0 0 0 1px rgba(255,255,255,0.1),
              inset 1.8px 3px 0px -2px rgba(255,255,255,0.6),
          ...
          .btn-glass-text-${filterId} {
            text-shadow: 0 1px 2px rgba(15,13,10,0.3);
            transition: color 400ms cubic-bezier(1, 0, 0.4, 1);
          }
          @media (hover: hover) {
            .btn-glass-${filterId}:not(:disabled):hover { transform: scale(1.03); }
          }
          .btn-glass-${filterId}:not(:disabled):active { transform: scale(0.96); }
        `}</style>
        ...
        >
          <span
            className={`btn-glass-lens-${filterId} absolute inset-0 -z-10 rounded-[inherit] pointer-events-none`}
          />
          <span
            className={cn(
              `btn-glass-text-${filterId} relative z-10 w-full flex items-center justify-center gap-[inherit] select-none`,
              contentClassName,
            )}
          >
            {children}
